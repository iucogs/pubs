...
if (isset($GLOBALS['HTTP_RAW_POST_DATA']))
{
	...
	// Ruth 4/12
		...
		$jsonString = '{"error22": "'.$citations->error.'", "page": "'.$result[3].'", "total_count": "'.$result[1].'", "citations":'.json_encode($result[0]).', "similar_citations_array": '.json_encode($result[2]).', "fullcollection_citations_array": '.json_encode($result[4]).', "sections_array": '.json_encode($result[5]).'}'; 		
		echo $jsonString;
	}
	else if($type == "delete")
	{
