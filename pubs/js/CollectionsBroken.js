...
Page.showEnterCitations = function()
{
	...
	if (document.getElementById('inputOptionsMenu').value == "1")  //paste citations
	{
		...
		html += '<p><input type="button" onclick="Page.parseTextIntoCollection_request(Page.parseTextIntoCollection_response, textareaform.citationInput.value, textareaform.entryName.value);" value="Insert citation(s)"></p>';
		html += '</form>';
