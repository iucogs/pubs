...
function parseAuthorMLA($str)
{
	...
	$editorsPattern = '/^(.*)(\bed\b|\beds\b)(.*)$/i';  		 // (Names) (EDS.)
	...
	{
		$authorStr = $match[1]; //processAuthNames($match[1]); //$match[1];
...
function processAuthNames($str)   // Process names for TITLE and EDS case only
{
